    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='askmeapp.Question')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='profile',
            name='questionlikes',
            field=models.ManyToManyField(default=0, to='askmeapp.QuestionLike'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
